    ...
    return (
        <div className="footer" id="footer">
            ...
            <p className='footer-info'>
                &copy; Michelle  |  <a href="https://www.docdroid.net/4Vjc6Md/fake-resume-docx" className="link">download resume</a>  |  <a href="https://colorhunt.co/palette/325288f4eee8f5cebe114e60">color palette</a>  |  made with <img id="react-icon" src="https://img.icons8.com/color/48/000000/react-native.png" alt="React"/>
            </p>
